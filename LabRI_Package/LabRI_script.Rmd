...
<div style='text-align: justify; color: black;'>When the total percentages of values POTD, PBLRL, PAURL, DPORI, and PORI, exceed 10%, 5.7%, 5.7%, 4.7%, and 6.7%, respectively, the table cell will have a red background. In these cases, it is recommended to review the exclusion criteria for reference individuals (if direct sampling is used) or the filtering criteria applied to the original database (if indirect sampling is used), or to review the partitioning used by sex or age group.</div><hr style='border: none; border-top: 1px solid #120a8f; margin-top: 5px; margin-bottom: 5px;'>
