...
pacman::p_load("AID", "DT", "FactoMineR", "KernSmooth", "MASS", "MethComp",
               ...
               "readxl", "refineR", "reflimR","reshape2", "rmarkdown",
               "scales", "stats", "stringi", "systemfonts","tools", "utf8",
               "univOutl", "xfun","writexl", "zlog","shinythemes","shiny")
...
ui <- fluidPage(
  ...
  # C.1. Main Container for the Application Header

  tags$div(

    ## C.1.1. Main Container Style, Including Gradient Background
    ...
    ## C.1.3. Sub-div for Title and Subtitle
    ...
    ### C.1.3.1. Main Title of the Application
    ...
    ### C.1.3.2. Subtitle Below the Main Title
  ...
  # C.3. TabsetPanel for Adding Tabs


  tabsetPanel(id = "tabs",


              ## C.3.1 Configuration Tab Panel
              ...
              tabPanel("Configuration",
                       sidebarLayout(
                         ...
                         ### C.3.1.1. Sidebar Panel for Configuration Inputs
                         ...
                         sidebarPanel(
                           ...
                           #### C.3.1.1.1. Input: Name of Responsible Specialist
                           ...
                           #### C.3.1.1.2. Input: Define the Dataset
                           ...
                           #### C.3.1.1.3. Input: Set the Type of Reference
                           ...
                           #### C.3.1.1.4. Input: Information for Study
                           ####            Traceability
                           ...
                           #### C.3.1.1.5. Input: Provide the Comparative Reference Interval
                           ####            (if applicable)
                           ...
                           #### C.3.1.1.6. Define the sampling method used for the
                           ####            study (if applicable)
                           ...
                           ##### C.3.1.1.7.1. Save Configuration
                           ...
                           ##### C.3.1.1.7.2. Clear Configuration
                         ...
                         #### C.3.1.2. Main Panel for Report Viewing
  ...
  tags$p("Developed by Alan Carvalho Dias |
    ...
    ## C.4.1. GitHub Icon with Text Below the Icon

    tags$a(
      href = "https://github.com/labrgrupo/LabRI_Tool",
      target = "_blank",
    ...
    ## C.4.2. Website Icon with Hyperlink
...
server <- function(input, output, session) {
  ...
  # D.1. Define the Directory Where the Report Will Be Saved


  output_dir <- "5_Output_Report"


  # D.2. Create an Accessible Path in Shiny for the Directory Where the Report is Saved
  ...
  ## D.3.1. Read the File Based on Its Extension
  ...
  # D.4. Observer to Update the Column List with Names in selectInput
  ...
  # D.5. Observer to Save Configuration
  ...
  # D.7. Observer to Generate Report
  ...
  observeEvent(input$generate_report, {
    ...
    withProgress(message = 'Generating Report...', value = 0, {
      tryCatch({
        incProgress(0.1, detail = "Preparing parameters...")
        save_params(input)


        ## D.7.1. Set the Path to Save the Report Inside 5_Output_Report
        ...
        ## D.7.2. Simulated Rendering Steps


        incProgress(0.3, detail = "Initializing RMarkdown rendering...")


        ## D.7.3. Rendering the RMarkdown Report


        for (i in 1:5) {  # Dividing into 5 Fictional Steps to Display Progress at 10% Each
          Sys.sleep(0.2)  # Simulating Processing Time
          incProgress(0.1, detail = paste(10 * (i + 2), "% Rendered..."))
        }

        render("LabRI_Method.Rmd",
               output_file = output_file, params = params, envir = globalenv())

        incProgress(1, detail = "Report generated successfully!")


        ## D.7.4. Update the "Report" Tab Content with the Generated HTML
        ...
        ## D.7.5. Automatically Switch to the Report Tab


        updateTabsetPanel(session, "tabs", selected = "relatorio")


        ## D.7.6. Display a Message to the User Indicating Success


        showModal(modalDialog(
          title = "Report Completed",
          "The report was generated successfully and is available for
           viewing in the 'Report' tab.",
          easyClose = TRUE,
          footer = tagList(
            modalButton("Close"),
        ...
        ## D.7.7. Download function to save the file
