...
pacman::p_load("AID", "DT", "FactoMineR", "KernSmooth", "MASS", "MethComp",
               ...
               "ffp", "forecast", "ggQC", "ggplot2", "ggpubr","ggtext", "grid", 
               "gt","imputeTS", "installr", "irr", "janitor","kableExtra", 
               "knitr","lattice", "lubridate", "mclust", "mixR","modeest", 
               "moments","multimode", "multiway", "nortest","openxlsx","pacman", 
               "plotly","prettydoc", "qqplotr","readr","readxl","refineR", 
               "reflimR","reshape2", "rmarkdown","scales","shiny","shiny.exe",
               "shinythemes","stats", "stringi","systemfonts","tools","utf8",
               "univOutl", "xfun","writexl","zlog")
  ...
  observeEvent(input$generate_report, {
    ...
    withProgress(message = 'Please wait... Rendering...', value = 0.5, {
      tryCatch({
        ...
        ## D.7.1. Set the Path to Save the Report Inside 5_Report
        ...
        ## D.7.2. Rendering the RMarkdown Report
